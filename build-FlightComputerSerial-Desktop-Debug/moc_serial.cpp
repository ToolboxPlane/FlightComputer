...
QT_MOC_LITERAL(1, 7, 10), // "getChannel"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "channel"
QT_MOC_LITERAL(4, 27, 10), // "setChannel"
QT_MOC_LITERAL(5, 38, 3), // "val"
QT_MOC_LITERAL(6, 42, 4), // "read"
QT_MOC_LITERAL(7, 47, 4) // "send"

    },
    "Serial\0getChannel\0\0channel\0setChannel\0"
    "val\0read\0send"
};
...
static const uint qt_meta_data_Serial[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       4,    2,   37,    2, 0x4a /* Public | isScriptable */,
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->getChannel((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->setChannel((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
